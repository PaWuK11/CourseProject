...
@section('content')
    ...
    <title>Облік та оподаткування</title>
    <!-- Bootstrap core CSS -->
    ...
    <div style="background-image: url('https://traderevolution.ru/local/templates/landing/img/tradersin-background-main.png')" id="headerwrap">
        <div class="container">
            <div class="row centered">
                <div class="col-lg-12">
                    <h1>Облік та оподаткування</h1>
                </div><!--/.col-lg-12 -->
            </div><!--/.row -->
        </div><!--/.container -->
    </div><!--/.#headerwrap -->
