...
@section('content')
    ...
    <title>Автомобільний транспорт</title>
    <!-- Bootstrap core CSS -->
    ...
    <div style="background-image: url('https://krot.info/uploads/posts/2021-10/1635187885_41-krot-info-p-mashina-na-trasse-nochyu-mashini-krasivo-f-53.jpg')" id="headerwrap">
        <div class="container">
            <div class="row centered">
                <div class="col-lg-12">
                    <h1>Автомобільний транспорт</h1>
                </div><!--/.col-lg-12 -->
            </div><!--/.row -->
        </div><!--/.container -->
    </div><!--/.#headerwrap -->
