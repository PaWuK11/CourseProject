...
@section('content')
    ...
    <title>Опорядження будівель і споруд та будівельний дизайн</title>
    <!-- Bootstrap core CSS -->
    ...
    <div style="background-image: url('https://api.verholy.com/storage/sLs8d1oB15lGpsn9dknGwhouW1AtIIHN5876qQy4.jpeg')" id="headerwrap">
        <div class="container">
            <div class="row centered">
                <div class="col-lg-12">
                    <h1>Опорядження будівель і споруд та будівельний дизайн</h1>
                </div><!--/.col-lg-12 -->
            </div><!--/.row -->
        </div><!--/.container -->
    </div><!--/.#headerwrap -->
