...
@section('content')
    ...
    <title>Будівництво та експлуатація будівель і спорудц</title>
    <!-- Bootstrap core CSS -->
    ...
    <script type="text/javascript" src="../../js3/smoothscroll.js"></script>
    <script src="../../js3/Chart.js"></script>

    <div style="background-image: url('https://wallpapercrafter.com/sizes/2560x1440/14638-architecture-building-minimalism-dark-design-4k.jpg')" id="headerwrap">
        <div class="container">
            <div class="row centered">
                <div class="col-lg-12">
                    <h1>Будівництво та експлуатація будівель і споруд</h1>
                </div><!--/.col-lg-12 -->
            </div><!--/.row -->
        </div><!--/.container -->
    </div><!--/.#headerwrap -->
    ...
    <div class="container desc">
        <div class="row">
            ...
            <div class="col-lg-2 col-lg-offset-1">
                <h5>КОМПАНІЇ З ЯКИМИ СПІВПРАЦЮЄМО</h5>
            </div>
            <div class="col-lg-6">
